...
begin
  ...
  begin
    ShowMessage('Favor Informar um Período');
    ME_INI.SetFocus;
    Exit
  end;
  ...
  cdsServicos.Open;
    ...
    begin
      ShowMessage('Nenhum Registro de Serviços Encontrado.');
      cdsServicos.Close;
    end
    else
    begin
...
begin
  ...
  begin
    ShowMessage('          A T E N Ç Ã O  !!!!!!!!!   '+#13+
                '                                     '+#13+
                '   Grupo Cliente Não Encontrado      '+#13+
                '                                     ');
...
begin
  ...
  DM.cdsGrupoEmpresa.Open;
  Pesquisa(DM.cdsGrupoEmpresa,['NOME_DO_GRUPO','ID_GRUPO_EMPRESA'],['Grupo Cliente','Código'],[40,4],'','','','','Grupo Cliente','Grupo Cliente');
  edtCli.Text        := DM.cdsGrupoEmpresaID_GRUPO_EMPRESA.AsString;
  lblCliente.Caption := DM.cdsGrupoEmpresaNOME_DO_GRUPO.AsString;
  DBLookupComboBox1.SetFocus;
end;
